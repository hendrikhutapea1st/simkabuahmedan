    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-green-50 p-6 rounded-xl shadow-md text-center hover:shadow-lg transition-shadow" role="article" aria-labelledby="feature-6">
          ...
          <h3 id="feature-6" class="text-xl font-bold text-gray-800 mb-2">Keamanan Terjaga</h3>
          <p class="text-gray-600">Pengemasan aman dan higienis untuk menjaga kesegaran buah hingga ke tangan Anda</p>
        </div>
      </div>
    </div>
  </section>
